...
def add_course(request):
    ...
    context = { 'staff': staff,'customuser':customuser}
...
def add_course_save(request):
    if request.method != "POST":
        ...
        try:
            course_model = Courses(course_code=cc,course_name=cn,sem=sem,academic_year=ay,minor=minor,credits=cred,staff=stf)
            course_model.save()
